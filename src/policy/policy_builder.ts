...
import { PtgCovGuidedPolicy } from './ptg_cov_guided_policy';
...
export class PolicyBuilder {
    ...
    static buildPolicyByName(device: Device, hap: Hap, options: FuzzOptions): Policy {
        ...
        } else if (options.policyName === PolicyName.COV_GUIDED) {
            return new PtgCovGuidedPolicy(device, hap, PolicyName.COV_GUIDED);
        }
        else {
